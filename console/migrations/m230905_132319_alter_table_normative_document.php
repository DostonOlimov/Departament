...
/**
 * Class m230905_132319_alter_table_normative_document
 */
class m230905_132319_alter_table_normative_document extends Migration
{
    const TABLE_NAME = 'normative_document'; // set the current table name
    const COL_1 = 'status';
