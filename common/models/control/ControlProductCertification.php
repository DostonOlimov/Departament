...
class ControlProductCertification extends \yii\db\ActiveRecord
{
    ...
    {
        $this->date_to = $this->date_to ? Yii::$app->formatter->asDate($this->date_to, 'dd.MM.yyyy') : $this->date_to;
        $this->date_from = $this->date_from ? Yii::$app->formatter->asDate($this->date_from, 'dd.MM.yyyy') : $this->date_from;
