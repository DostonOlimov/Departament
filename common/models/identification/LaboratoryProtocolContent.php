...
/**
 * This is the model class for table "{{%laboratory_protocol_content}}".
 *
 * @property int $id
 * @property int|null $laboratory_protocol_id
 ...
 * @property int|null $unit_om
 *
 * @property LaboratoryProtocol $laboratoryProtocol
 * @property NormativeDocument $normativeDocument
 */
class LaboratoryProtocolContent extends \common\models\identification\LaboratoryProtocol
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return '{{%laboratory_protocol_content}}';
    }
    ...
    {
        return [
            [['laboratory_protocol_id', 'normative_document_id', 'requirement_range', 'unit_om'], 'integer'],
            ...
            [['laboratory_protocol_id'], 'exist', 'skipOnError' => true, 'targetClass' => LaboratoryProtocol::class, 'targetAttribute' => ['laboratory_protocol_id' => 'id']],
    ...
    /**
     * Gets query for [[LaboratoryProtocol]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getLaboratoryProtocol()
    {
        return $this->hasOne(LaboratoryProtocol::class, ['id' => 'laboratory_protocol_id']);
    }
