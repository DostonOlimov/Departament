...
class LocalActiveRecord extends ActiveRecord
{
        ...
        [
            ...
            [
                [
                    ...
                    'mfrd_date', 'start_date', 'end_date', 'risk_analisys_date', 'delivery_date', 'protocol_date'
                ],'strtotime'
            ],
    ...
    public function afterFind()
    {
        ...
        [
            ...
            'last_gov_control_date', 'mfrd_date', 'start_date', 'end_date', 'risk_analisys_date', 'delivery_date', 'protocol_date'
        ],'integertotime'],
    ...
    public function AttributeLabels()
    {
        return [
            ...
            'selected_product_id' => 'Mahsulot nomi',
            'summary_user_id' => 'Umumlashtiruvchi',
            'normative_document_id' => 'Me\'yoriy hujjat',
            'unit_om' => 'O\'lchov birligi',
    ...
    public static function getListOfUnitOfMeasure($type = null){
        $list = ArrayHelper::map(UnitOfMeasure::find()
        ->where(['status' => self::DOCUMENT_STATUS_CONFIRMED])
        ->andFilterWhere(['kind_of_quantity' => $type])
        ->all(),'id', 'code' ); 
        return $list;
    }
}
