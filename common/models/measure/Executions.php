...
class Executions extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['control_instruction_id'], 'exist', 'skipOnError' => true, 'targetClass' => ControlInstructions::class, 'targetAttribute' => ['control_instruction_id' => 'id']],
    ...
    {
        $this->first_date = Yii::$app->formatter->asDate($this->first_date, 'M/dd/yyy');
